...
export const UploadDropzone = ({
  ...
  return (
    <div
      ...
      onClick={handleClick}
      className={`
        relative border-2 border-dashed rounded-lg p-4 sm:p-6 md:p-8 text-center cursor-pointer transition-colors touch-manipulation
        ${
          isDragOver
    ...
    >
      ...
      {isUploading ? (
        <div className="flex flex-col items-center">
          <div className="animate-spin h-6 w-6 sm:h-8 sm:w-8 border-4 border-blue-500 border-t-transparent rounded-full mb-3 sm:mb-4"></div>
        ...
        <div className="flex flex-col items-center">
          <svg
            className="h-10 w-10 sm:h-12 sm:w-12 text-gray-400 mb-3 sm:mb-4"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <p className="text-[10px] sm:text-xs text-gray-500 mb-2 sm:mb-3">
            ...
            <span className="sm:hidden">
              Tap to browse and upload PDF files
            </span>
          </p>
